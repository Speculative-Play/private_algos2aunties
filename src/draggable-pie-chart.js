...
(function () {
    ...
    DraggablePiechart.prototype.moveAngle = function (i, amount) {
        ...
        //console.log('inside move angle')
        //console.log(this.data[i].angle)
        //console.log(amount)
    ...
    DraggablePiechart.prototype.draw = function () {
        ...
        //draw hole => convert pie chart to donutchart
        context.beginPath();
        context.moveTo(geometry.centerX,geometry.centerY); 
        context.arc(geometry.centerX, geometry.centerY , geometry.radius*.60, 0, 2 * Math.PI, false);
    ...
    DraggablePiechart.prototype.defaults = {
        ...
        drawSegment: function (context, piechart, centerX, centerY, radius, startingAngle, arcSize, format, collapsed) {
            ...
            context.rotate(startingAngle + arcSize/3);
